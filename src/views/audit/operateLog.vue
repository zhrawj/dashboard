      ...
      <el-card class="box-card">
        <div class="search-radius filter-container" style="border-radius: 4px;">
          <el-row type="flex" class="search-row" justify="space-between">
            ...
            <el-col :span="6">
              <el-input v-model="listQuery.title" placeholder="类型" style="width: 150px; margi" class="filter-item" @keyup.enter.native="handleFilter" />
            </el-col>
          </el-row>
          <el-row type="flex" class="search-row" justify="space-between">
            <el-col :span="6">
        ...
        >
          ...
          <el-table-column label="IP(位置)" min-width="110px" align="center">
            <template slot-scope="scope">
              <span>{{ scope.row.author }}</span>
            </template>
          </el-table-column>
          <el-table-column label="动作" min-width="110px" align="center">
            <template slot-scope="scope">
              <span>{{ scope.row.author }}</span>
            </template>
          </el-table-column>
          ...
          <el-table-column label="资源" min-width="110px" align="center">
            <template slot-scope="scope">
              <span>{{ scope.row.author }}</span>
            </template>
          </el-table-column>
