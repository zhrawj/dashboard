      ...
      <el-card class="box-card">
        <div class="search-radius filter-container" style="border-radius: 4px;">
          <el-row type="flex" class="search-row" justify="space-between">
            ...
            <el-col :span="6">
              <el-select v-model="listQuery.type" placeholder="用户" clearable class="filter-item" style="width: 150px">
                <el-option v-for="item in calendarTypeOptions" :key="item.key" :label="item.display_name+'('+item.key+')'" :value="item.key" />
              </el-select>
            </el-col>
            <el-col :span="6">
              <el-select v-model="listQuery.type" placeholder="角色" clearable class="filter-item" style="width: 150px">
                <el-option v-for="item in calendarTypeOptions" :key="item.key" :label="item.display_name+'('+item.key+')'" :value="item.key" />
              </el-select>
            </el-col>
          </el-row>
        ...
        >
          ...
          <el-table-column label="授权角色" min-width="110px" align="center">
            <template slot-scope="scope">
              <span>{{ scope.row.timestamp | parseTime('{y}-{m}-{d} {h}:{i}') }}</span>
            </template>
          </el-table-column>
          <el-table-column label="授权用户" min-width="110px" align="center">
            <template slot-scope="scope">
              <span>{{ scope.row.author }}</span>
            </template>
          </el-table-column>
          <el-table-column label="授权主机" min-width="110px" align="center">
            <template slot-scope="scope">
              <span>{{ scope.row.author }}</span>
            </template>
          </el-table-column>
          ...
          <el-table-column label="操作" align="center" fixed="right" width="230" class-name="small-padding">
            <template slot-scope="{row}">
              ...
              <el-button type="text" size="mini" icon="el-icon-delete" @click="handleUpdate(row)">
                删除
              </el-button>
            </template>
          </el-table-column>
